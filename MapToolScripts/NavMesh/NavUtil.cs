...
namespace Game.NavMesh
{
    ...
    public class NavUtil
	{
        ...
        public const float CONSTANT_SCALE = 360;
        ...
        /// <returns></returns>
        public static NavResCode LoadNavMeshFromResource(string filePath, out List<Triangle> navTriangles)
        {
        ...
        /// <returns></returns>
        public static NavResCode LoadNavMeshFromFile(ref List<Triangle> navTriangles, BinaryReader binReader)
        {
            try
            {
                // 读取版本号
